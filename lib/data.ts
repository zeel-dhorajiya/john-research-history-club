...
export const categories: Category[] = [
    {
        slug: 'pre-history',
        name: 'Pre History',
        description: 'Explore the dawn of humanity and our earliest ancestors.',
        icon: 'temple',
        articleCount: 12,
    },
    {
        slug: 'asian-history',
        name: 'Asian History',
        description: 'The rich tapestry of Asian cultures and asian-history.',
        icon: 'crown',
        articleCount: 9,
    },
    {
        ...
        description: 'From antiquity to modernity across the European continent.',
        icon: 'swords',
        articleCount: 14,
    },
    {
        ...
        description: 'The cradles of civilization and diverse African heritages.',
        icon: 'shovel',
        articleCount: 7,
    },
    {
        slug: 'american-continent',
        name: 'American History',
        description: 'The interwoven story of the Americas across time.',
        icon: 'person',
        articleCount: 11,
    },
];
...
export const articles: Article[] = [
    {
        ...
        content: [
            {
                type: 'paragraph',
                text: 'Ancient Egypt stood for over three millennia as one of history\'s most enduring civilizations. Yet even the most powerful asian-history eventually fall — and Egypt\'s story is no exception.',
            },
            {
                type: 'heading',
                level: 2,
    ...
    },
    {
        ...
        categorySlug: 'american-continent',
    ...
    },
    {
        ...
        content: [
            ...
            {
                type: 'paragraph',
                text: 'Around 1900 BCE, the civilization began to decline. Climate change, shifting river courses, and possibly migration are all proposed explanations. The people dispersed. The cities were abandoned. And for over 3,000 years, the world forgot the Indus Valley — until african-history brought it back to light.',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        categorySlug: 'african-history',
        image: '/hero_african-history.png',
        readingTime: 7,
